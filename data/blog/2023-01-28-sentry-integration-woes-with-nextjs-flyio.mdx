...
date: '2023-01-28'
tags: ['sentry', 'nextjs', 'fly.io', 'docker', 'github actions']
draft: false
...
I used GitHub actions, so it made sense to put the token in the repository secret, and then it can be used in GitHub actions. 
