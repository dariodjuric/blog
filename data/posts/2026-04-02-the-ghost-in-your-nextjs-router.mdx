...
tags: ['Next.js', 'React']
summary: During an incremental App Router migration, a probabilistic data structure buried in your client bundle can randomly turn working links into 404s with mangled URLs.
---
...
At build time, Next.js takes every route defined in your `app/` directory and encodes them into a [bloom filter](https://en.wikipedia.org/wiki/Bloom_filter), a compact, probabilistic data structure. This bloom filter gets shipped to the browser as part of your client-side JavaScript bundle.
