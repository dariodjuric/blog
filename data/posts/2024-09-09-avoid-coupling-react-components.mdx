---
title: Avoid coupling React components when passing functions down
tags: ['Component Design']
summary: Avoid tightly coupling parent and child components by passing callback functions down to child components instead of setters, creating more reusable and testable components.
---
...
There’s nothing particularly wrong with this approach, and it will function correctly. However, we have introduced a tight coupling between the `WelcomeStep` component and the `OnboardingSection` component.
